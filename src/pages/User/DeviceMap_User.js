...
export default function DeviceMap_User() {
  ...
  const fetchInverters = async () => {
    try {
      ...
      // ✅ Filter only the assigned inverter(s)
      // inverterAccess can be a single ID or an array of IDs
